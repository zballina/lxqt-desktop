...
private:
    ...
    DesktopWidgetPlugin * loadPlugin(QLibrary * lib, const QString & configId="default", const LxQt::PluginInfo &info = LxQt::PluginInfo());
    QLibrary* loadPluginLib(const LxQt::PluginInfo &pluginInfo);
...
private slots:
    ...
    void addPlugin(const LxQt::PluginInfo &pluginInfo);
