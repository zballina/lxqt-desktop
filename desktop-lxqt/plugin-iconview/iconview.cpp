...
IconView::IconView(DesktopScene * scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &info)
...
IconViewWidget::IconViewWidget(const QString & configId, LxQt::Settings * config)
{
