...
class IconView : public DesktopWidgetPlugin
{
    Q_OBJECT
public:
    IconView(DesktopScene * scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &info);
//    ~IconView();
...
class IconViewWidget : public QGraphicsView
{
    Q_OBJECT
public:
    IconViewWidget(const QString & configId, LxQt::Settings * config);
    ~IconViewWidget();
