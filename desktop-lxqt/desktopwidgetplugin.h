...
class DesktopWidgetPlugin : public QGraphicsObject
{
    Q_OBJECT
public:
    DesktopWidgetPlugin(DesktopScene *scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &info);
    ...
    LxQt::Settings *config() { return m_config; }
    ...
    LxQt::PluginInfo desktopFile() { return m_desktopFile; }

signals:
    void pluginResized(const QSizeF &size);

protected:
    LxQt::Settings * m_config;
    QString m_configId;
 ...
 */
typedef DesktopWidgetPlugin* (*DesktopWidgetInitFunction)(DesktopScene *scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &);
...
#define EXPORT_RAZOR_DESKTOP_WIDGET_PLUGIN_H \
    extern "C" DesktopWidgetPlugin* init(DesktopScene *scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &info);

/*! Helper macro for define RazorPanelPlugin.
    Place this macro in your plugin source file.
 */
#define EXPORT_RAZOR_DESKTOP_WIDGET_PLUGIN_CPP(PLUGINCLASS)        \
    DesktopWidgetPlugin* init(DesktopScene *scene, const QString & configId, LxQt::Settings * config, const LxQt::PluginInfo &info)              \
    {                                                       \
